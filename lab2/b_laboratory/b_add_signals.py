...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonComboBox.clicked.connect(self.onPuchButtonComboBoxClicked)  # TODO подключить слот для вывода текста из comboBox в plainTextEditLog при нажатии на кнопку
        ...
        self.comboBox.currentTextChanged.connect(self.onPuchButtonComboBoxClicked) # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
