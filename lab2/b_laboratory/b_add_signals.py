...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonComboBox.clicked.connect(self.onPuchButtonComboBoxClicked)  # подключить слот для вывода текста из comboBox в plainTextEditLog при нажатии на кнопку
        ...
        self.pushButtonPlainTextEdit.clicked.connect(self.onPushButtonPlaineTextEditClicked)  # подключить слот для вывода текста из plaineTextEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.comboBox.currentTextChanged.connect(self.onPuchButtonComboBoxClicked) # подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        ...
        self.dateTimeEdit.dateTimeChanged.connect(self.onPushButtonDateTimeEditClicked)  # подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def onPuchButtonComboBoxClicked(self):
        # self.textEdit.text()
    ...
    def onPushButtonPlaineTextEditClicked(self):
